...
{
    public partial class TypePhotoshoot : Form
    {
        public TypePhotoshoot()
        {
            InitializeComponent();
        }

        private void TypePhotoshoot_Load(object sender, EventArgs e)
        {
        ...
        {
            typephotoshootBindingSource.EndEdit();
            try
            {
                type_photoshootTableAdapter.Update(live_PhotoDataSet);
